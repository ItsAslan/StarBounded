...
public class MoonSkyRender extends IRenderHandler {

    private static final ResourceLocation earthTexture = ResourceManager.EARTH;
    private static final ResourceLocation sunTexture = ResourceManager.SUN;
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(MoonSkyRender.earthTexture);
        var23.startDrawingQuads();
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(MoonSkyRender.sunTexture);
    ...
    private void renderStars()
    {
        ...
        int numStars = 20000; // Number of stars
