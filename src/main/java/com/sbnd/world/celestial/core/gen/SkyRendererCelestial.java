...
import static com.sbnd.world.celestial.core.EnumCelestialType.*;
...
public class SkyRendererCelestial extends IRenderHandler {
    ...
    private void renderStar(WorldClient world, float partialTicks) {
        ...
        GL11.glRotatef(getCelestialAngle(body, world, partialTicks), 1.0F, 0.0F, 0.0F);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        GL11.glDepthMask(false);
    ...
    private float getTidallyLockedAngle(CelestialBody body, WorldClient world, float partialTicks) {
        ...
        float orbitalPeriod = (float) ((body.getOrbitalPeriodSeconds() / SbndUtil.SECONDS_MC_DAY) * SbndUtil.GAME_TICK);
